...
const cityEventGroups: Record<string, CityEventGroup[]> = {
  calgary: [
    ...
    },
    {
      ...
      badgeStyle: "amber",
      description: "Please arrive by 7:30am to complete registration and settle in. Doors close at 8am.\n\nThis is a 2-day program package — attendance on both days is required.",
      events: [
        {
          dates: "Sat, July 11",
          time: "7:30 – 11 AM",
          venue: "Shri Sitaram Mandir Society of Calgary",
          address: "3219 34 Ave SE, Calgary, AB T2B 2M6",
          note: "Doors close at 8am — please arrive on time.",
        },
        {
          dates: "Sun, July 12",
          time: "7:30 – 11 AM",
  ...
  vancouver: [
    {
      ...
      events: [
        ...
        },
        {
          dates: "Sun, July 19",
          time: "10:30 AM",
          title: "Special Satsang (Wisdom Talk)",
          venue: "Vedic Cultural Society of British Columbia",
          address: "8200 No 5 Rd, Richmond, BC V6Y 2V4",
        },
        {
          dates: "Tue, July 21",
          time: "5:30 – 7:30 PM",
          title: "Special Satsang (Wisdom Talk)",
          venue: "Shri Lakshmi Narayan Mandir, Surrey",
...
const faqGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What should I wear or bring?", a: "Please bring a personal meditation cushion.\n\nComfortable, loose-fitting clothing in natural fabrics is recommended. White or soft neutral tones are traditional, though not required. A shawl or light wrap is useful for seated sessions. All other essential materials will be provided." },
  ...
  },
  {
    ...
    items: [
      { q: "Is there a cost for the program?", a: "All meditation teachings and initiation are offered freely as a spiritual gift.\n\nTo help cover the practical costs of organizing the Canada programs, including venue, administration, participant access, online resources, and ongoing meditation support, **participants are asked to register through a one-time $100 All-Access Meditation Pass**.\n\nThis membership supports the volunteer-run, not-for-profit efforts of Mahayogi Siddhababa Spiritual Academy and helps make these programs accessible, organized, and sustainable for all seekers.\n\n**Your one-time $100 All-Access Meditation Pass includes:**", bullets: ["Access to the 2-day Himalayan Siddha Mahayog meditation program", "5 guided meditation classes, in person and/or online", "Access to eligible Canada Tour city events", "Online weekend guided group meditation", "Online student learning portal", "Online wisdom and Q&A sessions with His Holiness", "Continued guidance and support in the practice", "Free meditation access at participating Himalayan Siddha Mahayog centres worldwide, where available"], aExtra: "No sincere seeker will be turned away due to financial hardship. If the membership cost presents a barrier, please contact the organizing team." },
      { q: "Can I cancel or reschedule?", a: "Your Mahayog Meditation Membership can be refunded or transferred to a future intake where space is available. Contact canada@siddhamahayog.org for support." },
    ],
  },
  {
